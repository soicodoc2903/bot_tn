...
export const haiLoc = async (tcvId) => {
    ...
    if (isNhanLiXi) {
        ...
        chat(`${fromName} vừa hái được 1 [img]https://imgur.com/rLCjT8B.png[/img]`);
    }
}
...
export const moLiXi = async (tcvId) => {
    ...
    if (baoLiXi === 0 || baoLiXi === null || nhanLiXi) {
        chat(`${fromName} không có [img]https://imgur.com/rLCjT8B.png[/img] mà mở cái gì /gach`);
        return;
    }
    if (baoLiXi === 1) {
        ...
        if (isLuckyNumber) {
            if (quyEvent <= 0) {
                chat(`${fromName} vừa mở [img]https://imgur.com/rLCjT8B.png[/img] nhận được ${formatBac(MAX_BAC)} bạc nhưng trong lúc mang bảo vật về động phủ đã bị đạo tặc cướp mất /denm`);
                await setItem(`${tcvId}_${today}_${month}_lixi`, 0);
                return;
            } else if (quyEvent < MAX_BAC) {
                chat(`${fromName} [class=tukim]vừa mở [img]https://imgur.com/rLCjT8B.png[/img] nhận được ${formatBac(quyEvent)} bạc[/class] /phao`);
                ...
                chat(`${fromName} [class=tukim]vừa mở [img]https://imgur.com/rLCjT8B.png[/img] nhận được ${MAX_BAC} bạc[/class] /phao`);
        ...
        if (quyEvent <= 0) {
            chat(`${fromName} vừa mở [img]https://imgur.com/rLCjT8B.png[/img] nhận được ${formatBac(bacAmount)} bạc nhưng trong lúc mang bảo vật về động phủ đã bị đạo tặc cướp mất /denm`);
            await setItem(`${tcvId}_${today}_${month}_lixi`, 0);
            return;
            ...
            chat(`${fromName} [class=tukim]vừa mở [img]https://imgur.com/rLCjT8B.png[/img] nhận được ${bacAmount} bạc[/class] /phao`);
