...
export async function checkBank() {
    try {
        const response = await axios.get(`https://soi-tcvtool.xyz/truyencv/member/32302`);
...
export async function duyetNhieu(msg, tcvId) {
    ...
    chat(`${fromName} - Duyệt xong [img]https://cbox.im/i/ETcmb.gif[/img]`);
}
...
export async function xinVaoBang(memberId, bangPhai = 'vcmt') {
    ...
    if (bangName == 'tnng' || bangName == '๖ۣۜTiếu ๖ۣۜNgạo ๖ۣۜNhân ๖ۣۜGian') {
        return 1;    
    } else {
